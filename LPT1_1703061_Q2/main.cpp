...
// Q2. Show an OpenGL Program which will show three triangles aligned in x axis with overlapping with red color in yellow background using 3 VBO and 3 VAO
...
int main()
{
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(secondTriangle), thirdTriangle, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, (void *)0); // because the vertex data is tightly packed we can also specify 0 as the vertex attribute's stride to let OpenGL figure it out
    glEnableVertexAttribArray(0);
